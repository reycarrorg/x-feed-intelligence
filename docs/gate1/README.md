...
| Conservative deduplication and counting invariants | [Analysis Contracts](ANALYSIS_CONTRACTS.md#deterministic-deduplication) | DOM/recording counts and 42 reordered runs |
...
| Exact passive MV3 permissions and fail-closed state machine | [Extension Lifecycle](EXTENSION_LIFECYCLE.md) and [`contracts/v1`](../../contracts/v1) | Exact permission, transition, limit and stop checks |
...
| Authored synthetic corpus | [fixture manifest](../../fixtures/synthetic/v1/manifest.json) | Nine SHA-256 checks and complete coverage inventory |
